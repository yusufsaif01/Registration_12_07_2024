...
class PostService {
    ...
    async getPostsList(requestedData = {}) {
        try {
            ...
            { $project: { post: 1, likedByMe: 1, likes: 1, comments: { total: 1, data: { created_at: 1, comment: 1, commented_by: 1, club_academy_detail: { avatar_url: "$club_academy_detail.avatar_url", name: "$club_academy_detail.name", member_type: "$club_academy_detail.member_type", user_id: "$club_academy_detail.user_id" } } } } },
