	  ...
	  <tbody style="display: block;width: 80%; margin:auto;">
			...
			<tr style="display:block; width: 100%;text-align: center;">
				<td style="display:block; width: 100%; text-align: center;">
					...
					font-size: 16px;font-weight: 300;color:#626262;
					">
						Once you have approved the contract, the player would be treated as a professional player on the YFTChain portal and his professional status will be associated with your ${category}.</p>
				</td>
			</tr>
			<tr style="height: 20px;">
				<td></td>
